...
Date: 2019-01-24 14:45
Tags: mini-assignment
Slug: minihw01-can-twitter-predict-election-results
Summary: An in-class, group-based mini-homework about a data science study that used Twitter data to predict election outcomes.
Show_summary: true
Show_link: true

[**Due:** End of class (2:45pm) on January 24, 2019]{.h3}
...
[Upload your responses to Blackboard][blackboard-assignment] as either a Microsoft Word document (DOCX format) or as a PDF.
Your responses should be written using full sentences and proper spelling and grammar.
Submit whatever you have completed by the end of the class period.
...
[blackboard-assignment]: https://mymasonportal.gmu.edu/webapps/blackboard/content/listContent.jsp?course_id=_359486_1&content_id=_8843087_1
